...
public class BlockTagUtils {
     ...
     * @param tagToBlockIds A mapping from tag ID to a set of block IDs (loader-specific code should provide this).
     * @param tagIdList The list of tag IDs to check.
     * @return true if the block ID is in any tag, false otherwise.
     */
    public static boolean isBlockIdInTags(String blockId, List<String> tagIdList, java.util.function.Function<String, Set<String>> tagToBlockIds) {
    ...
    /**
     * Splits config entries into block IDs and tag IDs.
     * Tag IDs are expected to start with "#" (e.g., "#minecraft:logs").
